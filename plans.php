...
<section id="plans">
    ...
    <div class="plans freepack">
        <h1>FREE PACK</h1>
        <div>
        <p> <b>Price:</b> FREE</p>
        <hr>
        <p> <b>Quality:</b> 480P </p>
        <hr>
        <p> <b>No Ads:</b> <i class="fas fa-times-circle"></i> </p>
        <hr>
        <p> <b>Premium Contents:</b> <i class="fas fa-times-circle"></i> </p>
        <hr>
        <p> <b>Watching in All Devices:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <p> <b>Download Videos:</b> <i class="fas fa-times-circle"></i> </p>
        <hr>
        <p> <b>Cancel Anytime:</b> <i class="fas fa-check-circle"></i></p>
        <hr>
        <a href="signup.php"><button>SELECT</button></a>

    </div>

    </div>

    <div class="plans premiumpack">
    
        <h1>PREMIUM PACK</h1>
        <div>
        <p> <b>Price:</b> 4.99$</p>
        <hr>
        <p> <b>Quality:</b> 1080p </p>
        <hr>
        <p> <b>No Ads:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <p> <b>Premium Contents:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <p> <b>Watching in All Devices:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <p> <b>Download Videos:</b> <i class="fas fa-times-circle"></i> </p>
    ...
    <div class="plans ultrapack">
        ...
        <p> <b>Watching in All Devices:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <p> <b>Download Videos:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <p> <b>Cancel Anytime:</b> <i class="fas fa-check-circle"></i> </p>
        <hr>
        <a href="signup.php"><button>SELECT</button></a>
