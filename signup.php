...
<section id="signupsection">
    ...
    <div class="signupsection">
            ...
            <input id="ccn" type="tel" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="Card Number:">
            <input class="required" id="field" type="number" max="999" pattern="([0-9]|[0-9]|[0-9])" name="cvv" placeholder="CVV:"/>
            
            <div>
               
            <input name="expiry" id="expiry" type="text" placeholder="Expire Date: (YYYY/MM)">
            </div>
            <a href="index.php"><button>SIGN UP</button></a>
    </div>
